...
import { fetchLeaguesByGame } from '../app/leaguesAPI.js';
...
{   
    ...
    async function fetchData(numpage=1,nbritems)
    {
        ...
        const data = await fetchLeaguesByGame(numpage,nbritems,currentGame);
